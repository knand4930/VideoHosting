...
urlpatterns = [
    ...
    path('video/playlist/update/delete/<int:pk>/', VideoPlaylistUpdateDelete.as_view(),
         name='VideoPlaylistUpdateDelete'),
    ...
    path('content/unit/update/delete/<uuid:pk>', ContentUnitDeleteUpdateAPI.as_view(),
         name='ContentUnitDeleteUpdateAPI'),
    ...
    # path('player/post/get/api/', UserSettingsView.as_view(), name='UserSettingsView'),
    # path('player/delete/update/api/<int:pk>/', UserSettingsView.as_view(), name='UserSettingsView'),
]
